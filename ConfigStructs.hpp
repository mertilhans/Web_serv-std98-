...
// Bu zengin struct'lar isim çakışmasını önlemek için namespace raw içine
// alındı: Server.hpp hâlâ global scope'ta (namespace'siz) daha basit bir
// ServerConfig/LocationConfig kullanıyor (bkz. configparser.hpp). main.cpp
// bu ikisi arasında bir çevirici (convertConfigs) ile köprü kuruyor.
namespace raw
{
